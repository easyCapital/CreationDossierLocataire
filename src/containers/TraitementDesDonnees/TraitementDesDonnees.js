import { TraitementDesDonneesWrapper } from "./TraitementDesDonnees.style";

export default function TraitementDesDonnees() {
  return (
    <TraitementDesDonneesWrapper>
      <div>
      ...
      <p>
        Conformément au <i>Règlement général sur la protection des données</i>{" "}
        (RGPD), cette politique de confidentialité est conforme aux
        <b> règlements suivants</b>.
      </p>
      ...
      <p>
        ...
        ces finalités; le traitement ultérieur à des fins archi artistiques dans
      ...
      <p>
        ...
        elles sont traitées, soient effacées on rectifiées sans tarder
        (exactitude) ;
      </p>
      <p>
        ...
        l'article 89, paragraphe 1, pour autant que soient
      </p>
      mises en œuvre les mesures techniques et organisationnelles appropriées
      requises par le règlement afin de garantir les droits et libertés de la
      ...
      <p>
        a. les conditions énoncées dans la présente politique de confidentialité
        et
      </p>
      <p>
      ...
      <p>Données personnelles que nous collectons</p>
      ...
      <p>g. Domicile</p>
      <p>h. Données de remplissage automatique</p>
      <p>
        Ces données peuvent être recueillies au moyen des méthodes suivantes :
      </p>
      <p>Formulaire de création de dossier</p>
      <p>
        Veuillez noter que nous ne collectons que les données qui nous aident à
        atteindre 1'objectif énoncé dans cette politique de confidentialité.
        Nous ne recueillerons pas de données supplémentaires sans nous en
      ...
      <p>a. Dans le formulaire</p>
      <h2>Avec qui nous Partageons les données personnelles</h2>
      <p>Employés</p>
      <p>
        Nous pourrons divulguer à tout membre de notre organisation les données
      ...
      <p>
        ...
        noter que nous ne sommes pas responsables et n'ayons pas de contrôle sur
      ...
      <p>
        Nous ne conservons pas vos données personnelles demandées lors du
        formulaire de création de dossier. Vous êtes la seule personne a y avoir
        accès.
      </p>
      <p>
        ...
        L'Intemet en sa totalité peut être, parfois, peu sûr et donc nous sommes
        incapables de garantir la sécurité des données des utilisateurs au-delà
      ...
      <p>d. droit de restreindre le traitement</p>
      <p>e. droit à la portabilité des données</p>
      <p>f. droit d'objection</p>
      <p>
      ...
      <p>Benoit Cardinault</p>
      <p>70 avenue de Branne, 33370, Tresses bcardinault@easycapital.fr</p>
      <p>06 01 73 09 58</p>
      <h2>Modifications</h2>
      <p>
      ...
      <h2>Contact</h2>
      <p>
        Si vous ayez des questions à nous poser, n'hésitez pas à communiquer
        avec nous en utilisant ce qui suit:
      </p>
      <p>06 01 73 09 58 bcardinault@easycapital.fr</p>
