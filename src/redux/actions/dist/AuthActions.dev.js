...
var RegisterAction = function RegisterAction(credentials, router) {
  return function (dispatch) {
    ...
    (0, _AuthServices.RegisterUserService)(credentials).then(function (res) {
...
var LoginAction = function LoginAction(credentials, router) {
  return function (dispatch) {
    ...
    (0, _AuthServices.LoginUserService)(credentials).then(function (res) {
      if (res.hasOwnProperty("success") && res.success === true) {
...
var LogoutAction = function LogoutAction() {
  return function (dispatch) {
    ...
    (0, _AuthServices.LogOutUserService)().then(function (res) {
      if (res.hasOwnProperty("success") && res.success === true) {
        dispatch({
